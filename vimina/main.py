...
def handleCallback(devicename, msgAndTime_t, data=None):
    #print msgAndTime_t
    ...
    osc = makeOSC(devicename, status, channel, data1, data2)
...
# convert to OSC
def makeOSC(devicename, status, channel, data1, data2):
    params = {
        "channel":channel,
        "data1":data1,
        "data2":data2
